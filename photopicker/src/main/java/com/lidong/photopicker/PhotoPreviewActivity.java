...
public class PhotoPreviewActivity extends AppCompatActivity implements PhotoPagerAdapter.PhotoViewClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.photo_activity_image_preview);
    ...
    public void updateActionBarTitle() {
        getSupportActionBar().setTitle(
                getString(R.string.photo_image_index, mViewPager.getCurrentItem() + 1, paths.size()));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.photo_menu_preview, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_discard){
            ...
            Snackbar snackbar = Snackbar.make(getWindow().getDecorView().findViewById(android.R.id.content), R.string.photo_deleted_a_photo,
                    Snackbar.LENGTH_LONG);
            if(paths.size() <= 1){
                // 最后一张照片弹出删除提示
                // show confirm dialog
                new AlertDialog.Builder(this)
                        .setTitle(R.string.photo_confirm_to_delete)
                        .setPositiveButton(R.string.photo_yes, new DialogInterface.OnClickListener() {
            ...
            snackbar.setAction(R.string.photo_undo, new View.OnClickListener() {
                @Override
