...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void setNum(int num,int num1) {
        this.num = num;
        this.num1 = num1;
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        ...
        ImageView point_img=(ImageView) tabView.findViewById(R.id.img);
//        int status= MyApp.getInstance().getStatus();
//        if (status==0){
//            point_img.setImageDrawable(getResources().getDrawable(R.drawable.pointcirle));
//        }else{
//            point_img.setImageDrawable(getResources().getDrawable(R.drawable.redpointcirle));
//        }
//        if (position==0){ //好友邀请
//            if (num>0){
...
//        mTabsContainer.addView(tabView, position);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorHeight > 0) {
            ...
            Pair<Float, Float> lines = getIndicatorCoordinates();
            canvas.drawRect(lines.first + mPaddingLeft, height - mIndicatorHeight-getPaddingBottom(), lines.second + mPaddingLeft, height-getPaddingBottom(), mRectPaint);
        }
    }
