...
public class ImageLoader {
	...
	private static ThreadPoolExecutor threadPool = new ThreadPoolExecutor(1000,3000, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>());
