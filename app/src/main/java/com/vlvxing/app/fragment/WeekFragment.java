...
public class WeekFragment extends Fragment {
    ...
    public static WeekFragment getInstance(int type, int t) {
        Bundle bundle = new Bundle();
        bundle.putInt("type", type);
        bundle.putInt("t", t); //1自驾游  2周末游
    ...
    private void initData() {
        ...
        type = bundle.getInt("type", 0); //1全部  2自助  3特价  4主题   5排序
        t = bundle.getInt("t", 0); // 1自驾游 2周末游
