...
public final class Constants {
     ...
     * 去哪儿网
     */
    public static final String QUNAR__KEY = "0748cebf8cf346cf64070333c7fed08f";   //从开发者平台获取
    public static final String QUNAR__TOKEN = "109cfbc62855bdc711a68c77c3e6bd97"; //从开发者平台获取
