...
public class DrivingRouteOverlay extends OverlayManager {
    ...
    boolean focus = false;
    private int lineWidth = 12;     //线路规划的宽度
    private int lineColor = Color.argb(255, 0, 0, 255);   //线路规划的颜色
        ...
        if (mRouteLine.getAllStep() != null
            ...
            for (DrivingRouteLine.DrivingStep step : mRouteLine.getAllStep()) {
                ...
                if (step.getEntrance() != null) {
                    overlayOptionses.add((new MarkerOptions()).title(step.getExitInstructions())
...
//                                            .fromResource(R.drawable.icon_lzqd)).zIndex(10));
//        }
...
//                                            BitmapDescriptorFactory
//                                                    .fromResource(R.drawable.icon_lzzd))
//                                                            .zIndex(10));
//        }
        // poly line
        if (mRouteLine.getAllStep() != null
...
//            }
            ...
            PolylineOptions option = new PolylineOptions().points(points).textureIndex(traffics)
                    .width(lineWidth).dottedLine(isDotLine).focus(true)
...
//            }
    ...
    public void setLineColorRed() {
        ...
        lineColor = Color.argb(255, 255, 0, 0);
    } 
    
    public void setLineColorBlue() {
    	
        lineColor = Color.argb(255, 0, 0, 255);
    } 
    
    //icon_road_blue_arrow  icon_road_red_arrow
