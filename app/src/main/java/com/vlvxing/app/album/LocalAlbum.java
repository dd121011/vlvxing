...
//import com.fblife.lushu.album.util.ImageUtils;
...
////                    .setImageSize(new ImageSize(MyApp.getScreenWidth()/4, 0))
...
//                convertView = LayoutInflater.from(context).inflate(R.layout.item_albumfoler, viewGroup,false);
...
//            viewHolder.num.setText(files.size()+"");
//            if (files.size() > 0) {
