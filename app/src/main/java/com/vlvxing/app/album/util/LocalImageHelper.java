...
public class LocalImageHelper {
    ...
    public String setCameraImgPath() {
        String foloder= Constants.CACHE_DIR_IMAGE+ "/PostPicture/";
    ...
    private LocalImageHelper(MyApp context) {
    ...
    public static void init(MyApp context) {
