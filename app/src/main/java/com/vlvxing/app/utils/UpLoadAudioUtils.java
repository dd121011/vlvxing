...
//    private String endpoint = "http://oss-cn-hangzhou.aliyuncs.com";
    private String endpoint = "http://oss-cn-shanghai.aliyuncs.com"; //服务端设置的回源网站(参考：https://help.aliyun.com/knowledge_detail/39585.html)
//    private String secretToken;
//    private String expireTime;

    //传递进来的
    private String filePath ; //音频文件的本地路径
...
//    public String videoID ;
    ...
    public UpLoadAudioUtils(Context context, String filePath, MyProcessDialog progressDialog) {
...
//        String vodPath = "mp4MultibitrateIn36/"; //上传路径的一部分，有服务器提供
        String vodPath = "audioinput/"; //上传路径的一部分，有服务器提供
        ...
        String ossName = vodPath + name1;
//        Log.i("test11","ossName:"+ossName);


        String name2 = name1.replace("amr","mp3");
        successUrl = "http://vlxingout.oss-cn-hangzhou.aliyuncs.com/videoout/" + name2;  //上传成功后的视频地址
//        Log.i("test11","音频：successurl:"+successUrl);

        uploader.addFile(filePath, endpoint, "zhangyiyan", ossName, getVodInfo());//文件大小<=4G
    }
...
//                        videoID = null;
        ...
        VODUploadCallback callback = new VODUploadCallback() {
            ...
            public void onUploadSucceed(UploadFileInfo info) {
                ...
                Log.i("test1","音频info.getFilePath() ------------------" + info.getFilePath());
                Log.i("test1","音频info：onsucceed ------------------" + info.getVodInfo().toString());
