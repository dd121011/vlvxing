...
public class ByCarActivity extends BaseActivity {
    ...
    private void init() {
        lin = new LinearLayout[]{lin1, lin2};
        line = new View[]{line1, line2};
    ...
    private void initData() {
        ...
        params.put("carInfoType",type+"");//0:接送机，1景点用车
        ...
        RemoteDataHandler.asyncPost(url, params, this, true, new RemoteDataHandler.Callback() {
            ...
            public void dataLoaded(ResponseData data) throws JSONException {
                ...
                if ("1".equals(status)) {
                    ...
                    ToastUtils.showT(ByCarActivity.this, model.getMessage());
                }
            }
        });
    }
    ...
    @OnClick({R.id.return_lin,R.id.lin1,R.id.lin2,R.id.tab_type, R.id.tab_local})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.return_lin:
                ...
                break;
            case R.id.lin1:
                remarkType(lin1, 0,line1);
                break;
            case R.id.lin2:
                remarkType(lin2, 1,line2);
                break;
    ...
    class myAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
           ViewHolder holder = null;
            ...
            if (StringUtils.isStringNull(bgUrl)) {
                holder.carImg.setImageResource(R.mipmap.qiche);
            } else {
