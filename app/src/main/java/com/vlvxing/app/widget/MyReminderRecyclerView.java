...
public class MyReminderRecyclerView extends RecyclerView {
    ...
    public MyReminderRecyclerView(Context context) {
        this(context, null);
    }

    public MyReminderRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyReminderRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                MyRemindAdapter.MyViewHolder viewHolder = (MyRemindAdapter.MyViewHolder) getChildViewHolder(view);
