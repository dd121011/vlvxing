...
public class HorizontalCalendar {
    ...
    //item正常状态下的背景颜色，item选择状态下的背景颜色
    private int backgroundColorNormal,backgroundColorSelected;
    //endregion
    ...
    private HorizontalCalendar(Builder builder) {
        ...
        this.backgroundColorNormal = builder.backgroundColorNormal;
        this.backgroundColorSelected = builder.backgroundColorSelected;
    ...
    public static class Builder {
        ...
        public Builder backgroundColor(int backgroundColorNormal,int backgroundColorSelected){
            this.backgroundColorNormal = backgroundColorNormal;
            this.backgroundColorSelected = backgroundColorSelected;
            return this;
        }
