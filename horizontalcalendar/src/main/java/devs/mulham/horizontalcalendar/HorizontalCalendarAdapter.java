...
//            holder.layoutBackground.setBackgroundColor(Color.parseColor("#FFFFFF"));
            holder.layoutBackground.setBackgroundColor(horizontalCalendar.getBackgroundColorSelected());
            //透明#00000000
...
//                horizontalCalendar.getTextSizeDayNumber());
        ...
        if (horizontalCalendar.isShowDayName()) {
            holder.txtDayNumber.setText(DateFormat.format(horizontalCalendar.getFormatDayName(), day).toString());
            holder.txtDayNumber.setTextSize(TypedValue.COMPLEX_UNIT_SP,
                    horizontalCalendar.getTextSizeDayName());
        } else {
            holder.txtDayNumber.setVisibility(View.GONE);
        }
        //月份+日
        if (horizontalCalendar.isShowMonthName()) {
            holder.txtMonthName.setText(DateFormat.format(horizontalCalendar.getFormatMonth(), day).toString().replaceAll("月*$", "")+"-"
            +DateFormat.format(horizontalCalendar.getFormatDayNumber(), day).toString());
